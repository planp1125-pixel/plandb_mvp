...
/* .dark { */
  :global(html.dark) .schema-comparison{
  --bg-primary: #1a1d21;
  --bg-secondary: #24292e;
  --bg-tertiary: #2d333b;
  --text-primary: #000000;
...
/* .dark .stat-item .count { */
  :global(html.dark) .stat-item .count {
  color: #f0f6fc;
}
/* .stat-item .label { */
:global(html.dark) .stat-item .label {
  font-size: 0.9em;
  color: #6c757d;
}
...
:global(html.dark) .patch-preview {
...
:global(html.dark) .patch-preview pre {
